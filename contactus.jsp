		...
		<tr>
		  <td  height="100%" align="center"><table cellSpacing="5"
					...
					<tr vAlign="top" align="left">
						...
						<table>
								<tr>
									<td class="Title">Please submit your query by filling the
										below :</td>
								</tr>
								<tr>
									<td><form id="form" method="post"  action="sendEmail" ><table>
                    <tr><td class="subMenu">Name:</td><td><input type="text" value="" name="uname"></td></tr>
                     <tr><td class="subMenu">Email:</td><td><input type="text" value="" name="uemail"></td></tr>
                      <tr><td class="subMenu">Phone:</td><td><input type="text" value="" name="uphone"></td></tr>
                       <tr><td class="subMenu">Message:</td><td><textarea style="width: 226px; height: 62px" name="umessage"></textarea></td></tr>
                    
                    </table> </td>
								</tr>
								<tr>
									<td
										style="padding-right: 30px; height: 70px; vertical-align: middle;"
										align="right"><a href="index.jsp">
										<input
											type="submit" class="btnAddtoCart" value=" Send "  /></a></td>
