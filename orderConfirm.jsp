		...
		<tr>
		  <td  height="100%" align="center"><table cellSpacing="5"
					...
					% -->
						...
						<td width="500">
						<table width="350"> <tr>
                        <td colspan="2"  style="padding-top: 20px;" class="Title">${servletMessage}<br>Your order is confirmed... Thank you.</td>
                    </tr>
                    <tr>
                        <td colspan="2" style=" height:70px;vertical-align: middle; " align="right"> <a href="index.jsp"><input type="submit" class="btnAddtoCart" value="     Back     " /></a></td>
