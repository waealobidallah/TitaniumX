		  ...
		  <td  height="100%" align="center"><table cellSpacing="5"
					...
					% -->
						...
						<td><table cellSpacing="0" cellPadding="0" border="0">
							...
							</table> </td><td width="500"style="padding-top: 20px;">
<label class="itemTitle" >Your Order is:</label>
<table><tr><td>
		      <c:forEach items="${shoppingCart.shoppingCartItems}" var="cart">		      		
					<form method="POST" action="removeFromCart">						
					<table  width="100%" ><tr>
							<td class="sub_titleGray"><c:out value="${cart.title}" /></td>
							<td class="sub_titleGray"><c:out value="${cart.price}" /></td>
						</tr>
						</table>
					</form>
			 </c:forEach>    
	</td></tr><tr><td>Total Price:  $ ${shoppingCart.totalPrice} CAD</td></tr>
	<tr><td style="padding-top: 20px;color: red; font-weight: bold;">
