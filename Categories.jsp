			...
			<td height="100%" align="center"><table cellSpacing="5"
					...
					% -->
						...
						<td align="center"><table width="400" class="ItemTable">
								<tr>
									<td style="padding-top: 20px; color: red; font-weight: bold;">
										<c:if test="${servletMessage != ''}">
											<label> ${servletMessage}</label>
										</c:if>
									</td>
								</tr>
							</table> <c:if test="${not empty productList}">
								<table border="0" class="ItemTable" width="100%">
									<tr>
										<td class="itemTableHeader">Item</td>
										<td class="itemTableHeader">Title</td>
										<td class="itemTableHeader">Price</td>
									</tr>
									<c:forEach items="${productList}" var="productListElem">
										...
										<tr>
											...
											<td><label class="ItemTitle"><a
													href="${pageContext.request.contextPath}/productInfo?productID=${productID}">${productName}</a>
											</label></td>

											<td><label class="ItemPrice">$${productPrice}
													CAD</label></td>
										</tr>
									</c:forEach>
								</table>
